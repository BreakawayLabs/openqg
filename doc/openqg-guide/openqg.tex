...
\pagestyle{fancy}
\fancyhead{}
\fancyhead[RO]{\textit{OpenQG (version 1.4.0)}}
...
\title{Formulation and users' guide for OpenQG.\\ Version 1.4.0}%
...
This document describes version 1.4.0 of OpenQG. 
...
Simply type \verb=make openqg= to compile, once you have edited the \verb=Makefile= to suit your system.
...
The OpenQG model consists of a main program and 69 subroutines, 8 of which remain with the main program in the file \verb=openqg.F=, the remainder having been separated out into other \verb=*.f/*.F= files.
...
& & subroutines\\
\hline
\verb=openqg.F= &     \verb=inpget=, \verb=zeroin*=, \verb=rbalin*=, \verb=prsamp*=, \verb=cfltry*=, \verb=resave=,&(8)\\
...
They were originally written to independently test particular routines, but can also be used to test the effects of changing certain input parameters, without needing to run the full OpenQG model.
\begin{description}
